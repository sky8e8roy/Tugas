...
<div class="modal fade bd-example-modal-lg" id="id_modaledit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <?= form_open('sektor/updatedata', ['class' => 'formsektor']) ?>
      <?= csrf_field(); ?>
      <div class="modal-body">
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Kode Sektor</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="kd_sek" name="kd_sek" value="<?= $kd_sek?>" readonly>
                    </div>
            </div>  
            ...
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Nama Sektor</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nm_sek" name="nm_sek" value="<?= $nm_sek?>">
