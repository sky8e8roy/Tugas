  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Rubah Kampung</h5>
        <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>

      </div>
      <?= form_open('kampung/updatedata', ['class' => 'formkampung']) ?>
      <?= csrf_field(); ?>
      <div class="modal-body">
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Kode Kampung</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="kd_kp" name="kd_kp" value="<?= $kd_kp?>" readonly>
                    </div>
            </div>  
            ...
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Nama Kampung</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nm_kp" name="nm_kp" value="<?= $nm_kp?>">
